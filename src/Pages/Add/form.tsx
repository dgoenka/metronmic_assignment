      ...
      >
        ...
        >
          <label htmlFor={"Lab name"}>
            Lab name{" "}
            <input type="text" {...register("Lab name", { required: true })} />
          </label>
          <label htmlFor={"Provider Group"}>
            Provider Group{" "}
            <select
              placeholder="Provider Group"
              {...register("Provider Group", { required: true })}
            >
              <option value="Alabama">Alabama</option>
              <option value="Alaska">Alaska</option>
            </select>
          </label>
          <label htmlFor={"Provider Unit"}>
            <select
              placeholder="Provider Unit"
              {...register("Provider Unit", { required: true })}
            >
              <option value="Alabama">Alabama</option>
              <option value="Alaska">Alaska</option>
            </select>
          ...
          <label htmlFor={"Zip Code"}>
            <input
              ...
              {...register("Zip Code", { pattern: /^\d{5}(?:[-\s]\d{4})?$/i })}
            />
          </label>
          ...
          <label htmlFor={"Office Phone"}>
            <input type="tel" placeholder="Office Phone" {...register} />
          </label>
      ...
      >
        ...
        >
          <select {...register("Timezone")}>
            ...
            <option value="Cuba Daylight Time[4]">Cuba Daylight Time[4]</option>
            ...
            <option value="Chatham Daylight Time">Chatham Daylight Time</option>
            <option value="Chatham Standard Time">Chatham Standard Time</option>
            ...
            <option value="Christmas Island Time">Christmas Island Time</option>
            <option value="Davis Time">Davis Time</option>
            <option value="Dumont d'Urville Time">Dumont d'Urville Time</option>
            ...
            <option value="Eastern European Time">Eastern European Time</option>
            ...
            <option value="Falkland Islands Time">Falkland Islands Time</option>
            ...
            <option value="Georgia Standard Time">Georgia Standard Time</option>
            ...
            <option value="Lord Howe Summer Time">Lord Howe Summer Time</option>
            ...
            <option value="Papua New Guinea Time">Papua New Guinea Time</option>
            ...
            <option value="Pohnpei Standard Time">Pohnpei Standard Time</option>
            ...
            <option value="Uruguay Standard Time">Uruguay Standard Time</option>
            ...
            <option value="Western European Time">Western European Time</option>
            <option value="Western Indonesian Time">
              Western Indonesian Time
            </option>
            <option value="Western Standard Time">Western Standard Time</option>
